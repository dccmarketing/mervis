...
// get all locations
$locations 	= mervis_get_posts( 'locations' );
$locmetas 	= array();
$options 	= array();
...
// remove duplicates - this becomes the select menu
// select menu changes what's displayed in the list
...
?><section class="top-form">
	<div>
		...
		<select>
			<option>Select an area...</option><?php
